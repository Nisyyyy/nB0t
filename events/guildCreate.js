...
module.exports = (bot, guild, discord) => {
  ...
  .addField("If you need to report a bug:","go to the [issue tracker](https://github.com/FHGDev/JSnBot/issues/new), or just use the `!contact` command, and it will send a message straight to my creator.")
