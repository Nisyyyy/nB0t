...
module.exports.run = (bot, message, args, discord) => {
  ...
  if (codes.includes(msg)) {
    ...
    .setDescription(`Correct Code! Use this invite to go to the nBot Base discord where you'll get the SuperPatron role, and more!`)
    .addField(`[Invite](https://discord.gg/qEFNkxB "Click to go to the nBot Base!")`)
